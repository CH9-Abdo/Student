...
class SettingsTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.sync_mode_combo.setEnabled(not offline)
        ...
        self.upload_btn.setEnabled(not offline)
        ...
        self.download_btn.setEnabled(not offline)
        sync_btns.addWidget(self.download_btn)
        
        if offline:
            sync_layout.addWidget(QLabel("<i>Sync is disabled in Offline Mode.</i>"))
