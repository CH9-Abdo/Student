    ...
    def refresh_data(self):
        try:
            ...
            for i, row in enumerate(data):
                ...
                # Level
                self.table.setItem(i, 2, QTableWidgetItem(f"Level {row.get('level', 1)}"))
                
                # Sessions
                self.table.setItem(i, 3, QTableWidgetItem(str(row.get('sessions_count', 0))))
